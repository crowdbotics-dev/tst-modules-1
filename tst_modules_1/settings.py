"""
Django settings for tst_modules_1 project.
...
ROOT_URLCONF = 'tst_modules_1.urls'
...
WSGI_APPLICATION = 'tst_modules_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_modules_1 API",
    "DESCRIPTION": "API documentation for tst_modules_1 App",
    "VERSION": "v1",
}
